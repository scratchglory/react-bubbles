...
- [ ] Explain what a token is used for. - A token is like a key, a way to prove authentication between the app and user.
- [ ] What steps can you take in your web apps to keep your data secure? - Using a Private Route, password strengths, testing for vulnerabilities
- [ ] Describe how web servers work. - Serves web pages it retrieves from the code to users upon request
- [ ] Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers. -get
